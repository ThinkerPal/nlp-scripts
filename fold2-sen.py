...
RESULTS_ROOT = "/project/results/paper2/europarl/fold2/"
DE_word = open(RESULTS_ROOT + "out.de" , 'r', encoding='utf-8') #change file to 'lang' word embeddings
DE_test = open('/project/data/europarl/results/test_2.de','r', encoding='utf-8')# open test data set file in 'lang'
...
EN_test = open('/project/data/europarl/results/test_2.en','r', encoding='utf-8')# open test data set file in 'lang'
